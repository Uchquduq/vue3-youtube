    ...
    <v-app-bar :elevation="0" class="">
      ...
      <v-toolbar-title>
        <svg viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon"
          style="pointer-events: none; display: block; width: 86px; height: 100%;">
      ...
      <v-text-field :elevation="0" :loading="loading" density="compact" variant="solo" label="Search"
      ...
      <v-avatar size="32px" class="ml-4 mr-10">
        <v-img alt="Avatar" src="https://avatars.githubusercontent.com/u/65082074?v=4"></v-img>
      </v-avatar>
        ...
        <v-row>
          <v-col v-for="n in 24" :key="n" cols="4">
            ...
            <v-card class="mx-auto" max-width="400" :elevation="0">
              ...
              <v-img class=" rounded-lg align-end text-white" height="200"
                src="https://cdn.vuetifyjs.com/images/cards/docks.jpg" cover>
              </v-img>

              

              <v-card-actions class="d-flex align-start justify-start ml-0 pl-0">
                <v-list-item class="w-100">
                  ...
                  <v-list-item-title>Javascript dasturalash tili haqida gaplashamiz</v-list-item-title>

                  <v-list-item-subtitle class="mt-1">Coders Valley</v-list-item-subtitle>
                  <v-list-item-subtitle class="mt-1">100k views • 1 years
